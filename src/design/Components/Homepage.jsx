      ...
      <div className="reportContainer">
        <div className="gridContainer">
            ...
            <div className="timeContainer">
              <ul className="trackingList">
                <li className="trackingListItem">
                  <a
                    href="/#"
                    className={isTimeDaily ? "DailyColor" : "Daily"}
                    onClick={handleClick}
                  >
                    Daily
                  </a>
                ...
                <li className="trackingListItem">
                  <a
                    href="/#"
                    className={isTimeWeekly ? "WeeklyColor" : "Weekly"}
                ...
                <li className="trackingListItem">
                  <a
                    href="/#"
                    className={isMonthly ? "MonthlyColor" : "Monthly"}
          ...
          <div className="workContainer">
            <div className="imageDesignContainer">
              ...
              <div className="smallerContainer">
                ...
                <div className="changingTimeContainer">
                  <div className="hrsTextWeeklyContainer">
                    ...
                    <p
                      className={
                        isTimeWeekly ? "hrsTextWeekly" : "hrsTextWeeklyAppear"
                      }
                    >
                      32hrs
                    </p>
                    <p
                      className={
                        isMonthly ? "hrsTextMonthlyAppear" : "hrsTextMonthly"
                      }
                    >
                      103hrs
                    </p>
          ...
          <div className="playContainer">
            <div className="imageDesignContainer1">
          ...
          <div className="studyContainer">
            <div className="imageDesignContainer2">
              <svg width="79" height="79" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <div className="exerciseContainer">
            <div className="imageDesignContainer3">
          ...
          <div className="socialContainer">
            <div className="imageDesignContainer4">
          ...
          <div className="selfCareContainer">
            <div className="imageDesignContainer5">
